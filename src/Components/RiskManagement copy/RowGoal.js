  ...
  return (
    <React.Fragment>
      <tr className="border-t">
        ...
        <tr>
        <th> <p><a><img className="icon-predict" src="images/transparent.gif" /></a>{`Under`}<span className={`rowBooks setnumcout ${(parseFloat(subItem.teamA_total).toFixed(2) < 0)?'red':''}`}>{teamA_total}</span></p>
        </th>
        ...
        <tr>
        <th> <p><a><img className="icon-predict" src="images/transparent.gif" /></a>{`Over`}<span className={`rowBooks setnumcout ${(parseFloat(subItem.teamB_total).toFixed(2) < 0)?'red':''}`}>{teamB_total}</span></p>
        </th>
        ...
        <td className="back-1"><a>{tieLayRate1}<span>{tieLaySize1}</span></a></td>
