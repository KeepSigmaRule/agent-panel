                                ...
                                <tr id="14" key={index} main_userid="wb77" style={{ display: 'table-row', borderBottom: "1px solid #7E97A7" }}>
                                    ...
                                    <td id="actionCol">
                                        <ul className="action">
                                            ...
                                            {
                                                (user.level === 0 && [6, 7].includes(item.level) ) &&
                                                <li>
                                                    <NavLink to="" onClick={() => { props.HandlePopup('change_status_modal_1', true, item) }} id="change14" className=" status1-bg ">
                                                        <div className="status1"></div>
                                                    </NavLink>
                                                </li>
                                            }
                                            {
                                                user.level + 1 === item.level &&
                                                <li>
