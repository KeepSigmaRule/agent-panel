  ...
  return (
    <>
      ...
      {!dataExist && <div id="noReportMessage"
        style={{ display: 'flex', textAlign: 'left' }}><p>Betting Profit & Loss enables you to review the bets you have placed.
          Specify the time period during which your bets were placed, the type of markets on which the bets were placed, and the sport.<br></br>
          Betting Profit &amp; Loss is available online for the past 2 months.</p></div>}

      {select === 0 && <div id="report" data-report="profitAndLossReport">
        <ul id="spotsUl" className="total-show input-list ud-line boxsetting">
        ...
        <div
          ...
          <p className="table-other">Profit and Loss is shown net of commission.</p></div>
      </div>}
